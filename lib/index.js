...
/**
 * Expose `StrideSpark` integration.
 */

var StrideSpark = exports = module.exports = integration('StrideSpark')
  .option('apiKey', '');
...
StrideSpark.prototype.initialize = function() {
  var self = this;
  this.ready();
...
StrideSpark.prototype.loaded = function() {
  return true;
};
...
StrideSpark.prototype.onpage = function(page) {
...
StrideSpark.prototype.onidentify = function(identify) {
...
StrideSpark.prototype.ongroup = function(group) {
...
StrideSpark.prototype.ontrack = function(track) {
  var json = track.json();
...
StrideSpark.prototype.onalias = function(alias) {
  var json = alias.json();
...
StrideSpark.prototype.normalize = function(msg) {
...
StrideSpark.prototype.send = function(path, msg, fn) {
  var url = scheme() + '//8jhlytchxh.execute-api.us-west-2.amazonaws.com/prod' + path;
...
StrideSpark.prototype.cookie = function(name, val) {
  var store = StrideSpark.storage();
...
StrideSpark.prototype.referrerId = function(query, ctx) {
